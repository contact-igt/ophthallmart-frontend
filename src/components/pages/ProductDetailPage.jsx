...
import { ChevronRight, Star, Heart, CheckCircle } from 'lucide-react';
import Button from '../shared/Button';

const ProductDetailPage = ({ product, onBack, onAdd, enquiryCart = [] }) => {
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex gap-4 pt-4">
                            <button
                                ...
                                className={`flex-1 py-3 px-6 rounded-lg font-bold text-base transition-all duration-200 flex items-center justify-center gap-2 group
                                    ${isAdded
