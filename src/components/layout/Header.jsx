...
const Header = ({ enquiryCart, handleNav, handleSearch, isMobileMenuOpen, setIsMobileMenuOpen }) => {
            ...
            <div className="max-w-7xl mx-auto px-4 py-4">
                <div className="flex items-center justify-between gap-8">
                    ...
                    <nav className="hidden lg:flex items-center gap-6 xl:gap-8 font-semibold text-[13px] text-[#0B2C4D] uppercase tracking-wide">
                        ...
                        <button onClick={() => handleNav('about')} className="hover:text-[#EA580C] transition-colors">
                            About Us
                        </button>
                        ...
                        <button onClick={() => handleNav('products')} className="hover:text-[#EA580C] transition-colors">
                            Products
                        </button>
                    ...
                    <div className="flex items-center gap-4">
                        <div className="hidden md:flex items-center bg-slate-50 border border-slate-200 rounded-full px-4 py-2 mr-2 w-48 lg:w-64 focus-within:border-[#EA580C] focus-within:ring-1 focus-within:ring-[#EA580C] transition-all">
                            ...
                            <Search
                                size={16}
                                className="text-slate-400 cursor-pointer hover:text-[#EA580C]"
                                onClick={onSearch}
                            />
                        </div>
            ...
            {isMobileMenuOpen && (
                <div className="lg:hidden bg-white border-t border-slate-100 p-4 shadow-xl absolute w-full z-50">
                    <nav className="flex flex-col gap-4 text-base font-medium text-[#0B2C4D]">
                        ...
                        <button onClick={() => handleNav('about')} className="text-left px-4 py-2 hover:bg-slate-50 rounded">
                            About Us
                        </button>
                        <button onClick={() => handleNav('shop')} className="text-left px-4 py-2 hover:bg-slate-50 rounded">
                            Shop
                        </button>
                        <button onClick={() => handleNav('products')} className="text-left px-4 py-2 hover:bg-slate-50 rounded">
                            Products
                        </button>
